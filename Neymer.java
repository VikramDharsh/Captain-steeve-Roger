...
public class Neymer {
	// everyone knows
			 public String name="neymer da silva santos junior";  //literal
			 public byte age=30;  // he was died at the age of 36
			 public String fatherName="neymer santos ";
			 public String motherName="nadine da silva";
			 ...
			 public Neymer( String[] hobbies, String[] children, String[] awards,String[] clubsHePlayed,  String[] publicimage, String[] goal)
			 {
